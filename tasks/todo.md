...
- [ ] 2. New e2e regression test: JWT-as-Bearer succeeds, API-token-as-Bearer still succeeds,
      garbage Bearer 401s — same `JwtAuthGuard`-protected route
- [ ] **Checkpoint** — lint/test/test:e2e/build clean in `apps/cms-api`; manual curl check
