...
import { SearchInput } from "@/views/learning/develop/react/components/SearchInput";
import { SectionSidebar } from "@/views/learning/develop/react/components/SectionSidebar";
import { DEFAULT_SECTION_STYLE } from "@/views/learning/develop/react/react-knowledge.types";

import type { ArchitectureSectionMeta } from "./data/types";
...
interface ArchitectureKnowledgePageProps {
...
export default function ArchitectureKnowledgePage({ sections, activeSectionId, searchQuery, totalTopics }: ArchitectureKnowledgePageProps) {
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <aside className="sticky top-0 hidden h-screen shrink-0 flex-col overflow-y-auto border-r bg-background dark:border-border/60 md:flex md:w-52 lg:w-60">
        <div className="border-b p-3 dark:border-border/60">
          <h2 className="text-sm font-semibold text-foreground">Architecture Patterns</h2>
