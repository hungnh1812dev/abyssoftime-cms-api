...
import type { KnowledgeSectionMeta } from "@/views/learning/develop/go/go-knowledge.types";
...
export default function GoKnowledgePage({ sections, activeSectionId, searchQuery, totalTopics }: GoKnowledgePageProps) {
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <aside className="sticky top-0 hidden h-screen shrink-0 flex-col overflow-y-auto border-r bg-background dark:border-border/60 md:flex md:w-52 lg:w-60">
        <div className="border-b p-3 dark:border-border/60">
          <h2 className="text-sm font-semibold text-foreground">Go Knowledge</h2>
